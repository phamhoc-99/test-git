...
class TopBar2 extends React.Component {
  ...
  onSignIn = () => {
    this.props.onSignIn();//nhan props cua component cha
  }
            ...
            <div className="container">
              ...
              <div className="w-9/12 md:w-9/12">
                  <div className="header__logo">
                    <div>
                    <Link to='/' ><img alt='logo' src='https://kfcvietnam.com.vn/templates/images/logo_pc.png' /></Link>
                    </div>
                  </div>
                </div>
                ...
                <div className="w-3/12 md:w-3/12">
                    ...
                    {account.name === '' ?
                      <button className="bg-red-500 hover:bg-red-700 text-white font-bold sm:py-2 sm:px-4 rounded "
                      ...
                      <div>
                        <img alt='avatar' src={account.picture} className="rounded-circle avatar" /> &nbsp;
                          ...
                          <i title="Log Out" type="button" onClick={this.onLogOut} className="fas fa-sign-out-alt"></i>
                        </p>
                      </div>
                    }
                  </div>
                  <div className="header__social">
                    {
                      account.name === '' ?
                        <Link to='/Carts' > <i className="fas fa-cart-plus "></i> </Link>
                        :
                        <div className='row'>
                          <div>
                            <Link to='/Carts' >
                        ...
                        </Dropdown.Menu>: <Link to='/listorder' >&nbsp;&nbsp;<i className="fas fa-tasks" title="Your list order"> List order </i></Link>
                        }
