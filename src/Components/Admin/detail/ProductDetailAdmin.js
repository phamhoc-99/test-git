            ...
            <form onSubmit={this.onSubmit} className='container'>
              ...
              <div className="form-group">
                ...
                <select
                  ...
                  onChange={this.onChange}
                  name='slug'>
                  <option value='electronic'>chicken</option>
                  <option value='pets'>Potato</option>
                  <option value='home'>gas</option>
                  <option value='fashion'>noodle</option>
                  <option value='other'>rice</option>
                  <option value='other'>combo</option>
                </select>
              </div>
              <div className="form-group ">
                <label >Prince:</label>
